...
export default function Shapes(){
    return (
        <div className="row-span-1 row-start-1 -mt-9 aspect-square md:col-span-1 md:col-2 md:mt-0">
...
function Geometries(){
    ...
    const materials = [
        ...
        new THREE.MeshStandardMaterial({color:0x1abc9c,roughness:0,metalness:0.5}),
        new THREE.MeshStandardMaterial({color:0xf1c40f,roughness:0.4,metalness:0.5}),
        new THREE.MeshStandardMaterial({color:0xd35400,roughness:0.1,metalness:0.5}),
        ...
        new THREE.MeshStandardMaterial({color:0x2980b9,roughness:0,
        metalness:1,}),
